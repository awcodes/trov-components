...
<div class="relative trov-multi-action-button"
    x-ref="wrapper"
    wire:ignore.self
    x-data="{
        open: false,
    ...
    <div x-on:keydown.escape.prevent.stop="close($refs.button)"
        ...
        <div x-ref="panel"
            ...
            style="display: none;"
            class="absolute left-0 right-auto z-10 flex flex-col items-stretch min-w-[200px] gap-2 p-2 shadow-2xl top-[105%] md:!left-auto md:right-0 bg-gray-900/50 dark:bg-black/80 rounded-xl">
